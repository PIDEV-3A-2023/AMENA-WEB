...

{
    ...
    public function new(Request $request, UserRepository $userRepository, UserPasswordHasherInterface $userPasswordHasher,NormalizerInterface $normalizer): Response
    {
