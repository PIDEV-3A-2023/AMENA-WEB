    ...
    <table class=\"table\">
        ...
        {% for coli in colis %}
            <tr>
                ...
                <td>
                    <a href=\"{{ path('app_colis_show', {'id': coli.id}) }}\">Afficher</a>
                    <a href=\"{{ path('app_colis_edit', {'id': coli.id}) }}\">Modifier</a>
                </td>
            </tr>
        {% else %}
            <tr>
...
{% endblock %}
", "colis/index.html.twig", "C:\\Users\\klair\\OneDrive\\Bureau\\web integré\\digidreamers\\templates\\colis\\index.html.twig");
    }
}
