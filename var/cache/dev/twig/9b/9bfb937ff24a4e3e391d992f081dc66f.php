...
class __TwigTemplate_52b7dfb0d9bfc8324ed42a03c9df377b extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["colis"]) || array_key_exists("colis", $context) ? $context["colis"] : (function () { throw new RuntimeError('Variable "colis" does not exist.', 23, $this->source); })()));
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["coli"]) {
            ...
            echo "</td>
                <td>";
            // line 30
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["coli"], "poids", [], "any", false, false, false, 30), "html", null, true);
            echo "</td>
                <td>";
            // line 31
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["coli"], "statut", [], "any", false, false, false, 31), "html", null, true);
            echo "</td>
                <td>";
            // line 32
