...
class __TwigTemplate_dba2bdb5c1e1b836124510e61e8ccb49 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("base.html.twig", "reclamations/index.html.twig", 1);
...
\t\t\t\t<h5>Description :</h5>
            ...
            <div class=\"float-right btn-group btn-group-sm\" style=\"width: 75px; height: 35px;\">
              <a href=\"";
                // line 31
                echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_reclamations_edit", ["id" => twig_get_attribute($this->env, $this->source, $context["r"], "id", [], "any", false, false, false, 31)]), "html", null, true);
                echo "\" class=\"btn btn-primary tooltips\" data-placement=\"top\" data-toggle=\"tooltip\" data-original-title=\"Edit\">
                <i class=\"fa fa-pencil\"></i>
              </a>
              <a href=\"";
                // line 34
                echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_reclamations_delete", ["id" => twig_get_attribute($this->env, $this->source, $context["r"], "id", [], "any", false, false, false, 34)]), "html", null, true);
...
";
        ...
        echo "\"class=\"btn btn-primary\">Reclamer</a>";
    ...
    {
        return array (  167 => 45,  164 => 44,  157 => 42,  143 => 34,  137 => 31,  130 => 27,  125 => 25,  116 => 18,  112 => 17,  109 => 16,  105 => 15,  97 => 9,  87 => 8,  74 => 4,  69 => 3,  59 => 2,  36 => 1,);
    }
...
\t\t\t\t<h5>Description :</h5>
            ...
            <div class=\"float-right btn-group btn-group-sm\" style=\"width: 75px; height: 35px;\">
              <a href=\"{{ path('app_reclamations_edit', {'id': r.id}) }}\" class=\"btn btn-primary tooltips\" data-placement=\"top\" data-toggle=\"tooltip\" data-original-title=\"Edit\">
                <i class=\"fa fa-pencil\"></i>
              </a>
