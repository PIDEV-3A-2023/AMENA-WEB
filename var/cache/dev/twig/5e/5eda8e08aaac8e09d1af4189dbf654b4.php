...
\t\t\t\t\t\t\t\t\t\t";
        ...
        if (twig_get_attribute($this->env, $this->source, ($context["user"] ?? null), "roles", [], "any", true, true, false, 37)) {
            // line 38
            echo "\t\t\t\t\t\t\t\t\t\t\t<p class=\"m-0\">";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 38, $this->source); })()), "roles", [], "any", false, false, false, 38), 0, [], "array", false, false, false, 38), "html", null, true);
            echo "</p>
\t\t\t\t\t\t\t\t\t\t";
        }
        // line 40
...
{% endblock %}
", "user/back/show.html.twig", "C:\\Users\\aymen\\Desktop\\prositsym\\digidreamers\\templates\\user\\back\\show.html.twig");
    }
}
