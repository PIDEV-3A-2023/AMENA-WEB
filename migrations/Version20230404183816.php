 ...
 */
final class Version20230404183816 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE annonces DROP FOREIGN KEY fk_idc');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `annonces` ADD CONSTRAINT c_idua FOREIGN KEY (ida_U) REFERENCES user (id) ON UPDATE CASCADE ON DELETE CASCADE');
        $this->addSql('ALTER TABLE `annonces` ADD CONSTRAINT fk_idc FOREIGN KEY (idcolis) REFERENCES colis (id) ON UPDATE CASCADE ON DELETE CASCADE');
