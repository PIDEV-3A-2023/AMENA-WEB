 ...
 */
final class Version20230404175928 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE annonces ADD id INT AUTO_INCREMENT NOT NULL, ADD ida_u_id INT DEFAULT NULL, ADD id_colis_id INT DEFAULT NULL, DROP id_annonce, DROP ida_U, DROP idColis, CHANGE type type VARCHAR(255) NOT NULL, CHANGE ville_dep ville_dep VARCHAR(255) NOT NULL, CHANGE ville_arr ville_arr VARCHAR(255) NOT NULL, CHANGE date_dep date_dep VARCHAR(255) NOT NULL, CHANGE date_arr date_arr VARCHAR(255) NOT NULL, CHANGE description description VARCHAR(255) NOT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (id)');
        $this->addSql('ALTER TABLE annonces ADD CONSTRAINT FK_CB988C6F6975C466 FOREIGN KEY (ida_u_id) REFERENCES `user` (id)');
        $this->addSql('ALTER TABLE annonces ADD CONSTRAINT FK_CB988C6F1DFD61E5 FOREIGN KEY (id_colis_id) REFERENCES `colis` (id)');
        $this->addSql('CREATE INDEX IDX_CB988C6F6975C466 ON annonces (ida_u_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE annonces MODIFY id INT NOT NULL');
        $this->addSql('ALTER TABLE annonces DROP FOREIGN KEY FK_CB988C6F6975C466');
        $this->addSql('ALTER TABLE annonces DROP FOREIGN KEY FK_CB988C6F1DFD61E5');
        $this->addSql('DROP INDEX IDX_CB988C6F6975C466 ON annonces');
        $this->addSql('DROP INDEX IDX_CB988C6F1DFD61E5 ON annonces');
        $this->addSql('DROP INDEX `PRIMARY` ON annonces');
        $this->addSql('ALTER TABLE annonces ADD id_annonce INT NOT NULL, ADD ida_U INT NOT NULL, ADD idColis INT NOT NULL, DROP id, DROP ida_u_id, DROP id_colis_id, CHANGE type type VARCHAR(20) NOT NULL, CHANGE ville_dep ville_dep VARCHAR(20) NOT NULL, CHANGE ville_arr ville_arr VARCHAR(20) NOT NULL, CHANGE date_dep date_dep VARCHAR(20) NOT NULL, CHANGE date_arr date_arr VARCHAR(20) NOT NULL, CHANGE description description VARCHAR(100) NOT NULL');
