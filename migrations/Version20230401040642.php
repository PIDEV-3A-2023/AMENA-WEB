 ...
 */
final class Version20230401040642 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE annonces ADD idColis  INT NOT NULL, DROP idColis, CHANGE ida_U ida_U INT NOT NULL');
        $this->addSql('ALTER TABLE annonces ADD CONSTRAINT FK_CB988C6F8973C782 FOREIGN KEY (ida_U) REFERENCES `user` (id)');
        $this->addSql('ALTER TABLE annonces ADD CONSTRAINT FK_CB988C6F4E5B26B8 FOREIGN KEY (idColis ) REFERENCES `colis` (id)');
        $this->addSql('CREATE INDEX IDX_CB988C6F4E5B26B8 ON annonces (idColis )');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE colisr (id INT AUTO_INCREMENT NOT NULL, id_c INT NOT NULL, id_u INT NOT NULL, INDEX fk_c1 (id_c), INDEX fk_user (id_u), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE `annonces` DROP FOREIGN KEY FK_CB988C6F4E5B26B8');
        $this->addSql('DROP INDEX IDX_CB988C6F4E5B26B8 ON `annonces`');
        $this->addSql('ALTER TABLE `annonces` DROP FOREIGN KEY FK_CB988C6F8973C782');
        $this->addSql('ALTER TABLE `annonces` ADD idColis INT DEFAULT NULL, DROP idColis , CHANGE ida_U ida_U INT DEFAULT NULL');
