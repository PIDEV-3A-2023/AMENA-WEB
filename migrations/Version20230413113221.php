 ...
 */
final class Version20230413113221 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_B6BD307FF0D67FFD ON message (senderId)');
        $this->addSql('CREATE INDEX IDX_B6BD307FE9A89CDD ON message (receiverId)');
